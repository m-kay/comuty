...
public class GoogleDirectionsReader {
	  ...
	  public final static void main(String[] args) {
	    ...
	    try {
	      ...
	      HttpGet httpGetRequest = new HttpGet("http://maps.googleapis.com/maps/api/directions/json?origin=Saint%20Gallen&destination=Zuerich&sensor=false&mode=transit&departure_time=1411490000");
